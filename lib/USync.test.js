...
describe('usync.import()', () => {
  test.concurrent(
    ...
    async () => {
      ...
      const commitAuthor = 'Test User <test-user@uber.com>';
      const contribAuthor = 'Other Test User <other-test-user@uber.com>';
  ...
  test.concurrent('handles importing from a fork', async () => {
    ...
    // prepare repos
    {
      ...
      // author the changes that will be imported
      {
        ...
        await fork.git.raw(['commit', '-m', 'modify file']);
...
describe('usync.land()', () => {
  test.concurrent('lands change in parent and configured repos', async () => {
    ...
    const subdir = 'sub-dir';
    const changeBranch = 'my-test-change';
    const contribAuthor = 'Test User <test-user@uber.com>';
    const contribAuthor2 = 'Other Test User <other-test-user@uber.com>';
